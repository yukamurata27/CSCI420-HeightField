...
void displayFunc()
{
  ...
  openGLMatrix.LookAt(0, 0, 3.6434262018, 0, 0, 0, 0, 1, 0);
  //openGLMatrix.Translate(0, 0, 0); // transform the object
  ...
  openGLMatrix.GetMatrix(p); // fill "p" with the matrix entries
